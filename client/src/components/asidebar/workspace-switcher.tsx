...
import { SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem, useSidebar } from '@/components/ui/sidebar'
  ...
  return (
    <>
      <SidebarGroupLabel className='w-full justify-between pr-0'>
        ...
        <button onClick={onOpen} className='flex size-5 items-center justify-center rounded-full border'>
